...
CLASS zcl_renting_load_data IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA: lt_brands    TYPE TABLE OF zrent_brans_pue,
          lt_cars      TYPE TABLE OF zrent_cars_pue,
          lt_customers TYPE TABLE OF zrent_custom_pue.
    ...
    DELETE FROM zrent_brans_pue.
    INSERT zrent_brans_pue FROM TABLE @lt_brands.

    SELECT * FROM zrent_brans_pue INTO TABLE @lt_brands.
    out->write( sy-dbcnt ).
...
DELETE FROM zrent_cars_pue.
INSERT zrent_cars_pue FROM TABLE @lt_cars.
SELECT * FROM zrent_cars_pue INTO TABLE @lt_cars.
out->write( sy-dbcnt ).


out->write( 'zrent_cars data insertedsuccessfully!').
...
out->write( 'zrent_customers data insertedsuccessfully!').
